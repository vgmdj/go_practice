...
func TestSearchInsertII(t *testing.T) {
	...
	ast.Equal(searchInsertII([]int{1, 3, 5, 6}, 5), 2)
	ast.Equal(searchInsertII([]int{1, 3, 5, 6}, 2), 1)
	ast.Equal(searchInsertII([]int{1, 3, 5, 6}, 7), 4)
	ast.Equal(searchInsertII([]int{1, 3, 5, 6}, 0), 0)
